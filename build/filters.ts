...
export const unicodeFilter = Object.freeze<string[]>([
	...
	// `woff2` is listed alongside `woff` because the brace glob matches an extension exactly: without it,
	// a bundled .woff2 is read as source and reported as thousands of bad unicode characters.
