...
| Doc | What it covers |
|---|---|
| [07-decision-log.md](07-decision-log.md) | **The running ADR log, decisions 1-161** — from spike calls through the beta-planning decisions. The tie-breaker on any doc conflict |
...
| [plans/](plans/) | The handoff prompts that drove (and will drive) the work, kept verbatim. UI Redesign set (`20`-`25`) **done**; product-completion set (`26`-`33`) **merged**; beta-gate set `34`-`38` (34 done, 35 mostly done — #120 open, 36-38 pending); QA wave of 16 Jul (issues #168-#182) **merged**; the light-path set **[42-light-path-loop.md](plans/42-light-path-loop.md)** (editor-first cold start; slices L1-L5) **merged** (PRs #202, #205, #206, #208, #209; run tracker #196) |
