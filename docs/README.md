...
| [23-validation-thesis-and-value-hypotheses.md](23-validation-thesis-and-value-hypotheses.md) | The validation thesis: founder context (Cursor dogfooding, validate→raise→greenfield-cloud), first-principles adoption laws for the tech-savvy non-technical user, falsifiable value-prop hypotheses VP1-VP7 with kill signals, and the ten open founder questions (kill criteria, WTP fake door, platform squeeze, retention-not-aha) |
