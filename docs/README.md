...
| [plans/](plans/) | The handoff prompts that drove (and will drive) the work, kept verbatim. UI Redesign set (`20`-`25`) **done**; product-completion set (`26`-`33`) **merged**; beta-gate set `34`-`38` (34 done, 35 mostly done — #120 open, 36-38 pending); QA wave of 16 Jul (issues #168-#182) **merged**; the light-path set **[42-light-path-loop.md](plans/42-light-path-loop.md)** (editor-first cold start; slices L1-L5) **merged** (PRs #202, #205, #206, #208, #209; run tracker #196); **Live: the Abstract Editor v2 wave (`43`-`49`)** — spec of record [43-editor-v2-spec.md](plans/43-editor-v2-spec.md), pixel source [design/abstract-editor-v2/](design/abstract-editor-v2/), master run prompt [RUN-editor-v2-loop.md](plans/RUN-editor-v2-loop.md), decisions 167-174 |
...
Working evidence directories: [design-audit/](design-audit/), [incidents/](incidents/),
