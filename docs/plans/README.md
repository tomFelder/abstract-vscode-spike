...
| [RUN-cursor-parity-remainder.md](RUN-cursor-parity-remainder.md) | **The 12 Aug re-cut.** WP-A's centrepiece was found already built, so the wave's centre moved to B/D/F. B (#293) and D1 (#292) merged; this is the handoff prompt for the remainder - F, A1, D2/D3, B residuals, C, E, G - one pathway at a time with adversarial validators. |
